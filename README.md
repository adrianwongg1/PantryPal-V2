...
**Status: early build-out (Phase 1 of 7).** The JavaFX version isn't touched by this — it stays where it is as the behavioral reference.
...
- Design tokens ported from a [Claude Design](https://claude.ai/design) system ("Modernist"), extended with PantryPal's own meal-type color scale
...
| `ANTHROPIC_API_KEY` | [console.anthropic.com](https://console.anthropic.com) — only required once AI routes land (Phase 3) |
